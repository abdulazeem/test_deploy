...
with st.sidebar:
        choose = option_menu(menu_title=None, options= [ "Chatbot", "Previous Responses","Create Embed-DB","Stop"],
                                 icons= ["bi-chat-left-text",'bi-database','bi-bricks',  'stop-circle-fill'],
